package com.ptech.foodbank.ui.navigation
...
import com.ptech.foodbank.databinding.FragmentNavigationBinding
...
class NavigationFragment : Fragment() {
    ...
    /**
     * RouteLine: Various route line related options can be customized here including applying route
     ...
     * Notice here the withRouteLineBelowLayerId option. The map is made up of layers. In this case
     * the route line will be placed below the "road-label" layer which is a good default for the
     * most common Mapbox navigation related maps. You should consider if this should be changed for
     * your use case especially if you are using a custom map style.
     */
     ...
     * data generated must be rendered by the [routeArrowView] in order to apply mutations to the
     * map.
     */
     ...
     * MapboxNavigation. When this observer is called the route data is used to draw route(s) on the
     * map.
     */
    private val routesObserver: RoutesObserver = RoutesObserver { routeUpdateResult ->
        ...
        routeLineApi.setNavigationRoutes(
            ...
            binding.mapNavView.getMapboxMap().getStyle()?.apply {
     ...
     * which changes the color of the route line behind the puck during navigation. If this option
     * is set to `false` (the default) in MapboxRouteLineOptions then it is not necessary to use
     * this listener.
     */
    ...
    override fun onCreateView(
        ...
        binding.mapNavView.getMapboxMap().loadStyleUri(NavigationStyles.NAVIGATION_DAY_STYLE) {
    ...
    private fun initNavigation() {
        ...
        locationComponent = binding.mapNavView.location.apply {
    ...
    private fun updateCamera(point: Point, bearing: Double?) {
        ...
        binding.mapNavView.camera.easeTo(
